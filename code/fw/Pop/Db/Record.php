...
class Record {
    ...
    /**
     * Database connection has been already made or not
     * @var bool
     */
    private static $isdb = false;

    /**
     * Last database connection to be stored in this variable
     * @var bool
     */
    private static $lastdb = false;
     ...
     */
    public function __construct(array $columns = null, \Pop\Db\Db $db = null, $tablename = null) {
     ...
     * @return \Pop\Db\Record
     */
    public static function findById($id, $limit = null, $tablename = null) {
        if (null !== $tablename) {
            $record = new static(null, null, $tablename);
        } else {
            $record = new static();
        }
