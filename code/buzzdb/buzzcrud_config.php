...
class buzzcrud_config
{
    ...
    // theme and language
    public static $theme = 'default'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of buzzcrud visual presentation. For using bootstrap you need to load it on your page.
    ...
    // scripts
    public static $load_bootstrap = false; // turn on, if you want to load bootstrap via buzzcrud
    public static $load_googlemap = true; // loads google map api for 'POINT' type. Turn off, if your site already uses it.
    public static $load_jquery = false; // loads jQuery, turn it off if you already have jQuery on your page. jQuery version must be at least 1.7. If your jQuery loads in the bottom of page, you must activate $manual_load and use  buzzcrud::load_css() & buzzcrud::load_js() on your page.
    ...
    public static $manual_load = true; // Allows you to disable buzzcruds css and js output, but you can use buzzcrud::load_css() & buzzcrud::load_js() in your code manually.
    ...
    public static $start_minimized = false; // Start all buzzcrud instances minimized.
    ...
    public static $upload_folder_def = '../uploads'; // Default uploads folder on your site, relative to buzzcrud folder or absolute path required. Folder is must exist.
    ...
    public static $email_from_name = 'buzzcrud Data Management System'; // email from name
    ...
    // buzzcrud folder url
    public static $scripts_url = ''; // URL to the buzzcrud folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/buzzcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/buzzcrud'. If empty - will be detected automatically
    ...
    // urls (relative to $scripts_url or buzzcrud's folder, if $scripts_url is not defined)
    ...
    public static $ajax_uri = 'buzzcrud_ajax.php'; // main ajax file or url
    // paths (relative to buzzcrud's folder)
    ...
    public static $autoclean_timeout = 3; // in seconds. Do not change, if not sure. buzzcrud clears old instances in session when you reload browser tab or open new tab with buzzcrud. In this case buzzcrud can't work in two tabs in the same time. You can increase timeout on your risk.
    
    
    // anti XSS
    public static $auto_xss_filtering = true; // enable all buzzcrud's POST and GET data filtering
