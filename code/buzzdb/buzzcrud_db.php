<?php
/** Database driver; f0ska buzzcrud v.1.6.16; 04/2014 */
class buzzcrud_db
{
    ...
    public static function get_instance($params = false)
    {
        ...
        if (!isset(self::$_instance[$instance_name]) or null === self::$_instance[$instance_name])
        {
            if (!is_array($params))
            {
                $dbuser = buzzcrud_config::$dbuser;
                $dbpass = buzzcrud_config::$dbpass;
                $dbname = buzzcrud_config::$dbname;
                $dbhost = buzzcrud_config::$dbhost;
                $dbencoding = buzzcrud_config::$dbencoding;
            }
    ...
    private function __construct($dbuser, $dbpass, $dbname, $dbhost, $dbencoding)
    {
        ...
        if (buzzcrud_config::$db_time_zone)
            $this->connect->query('SET time_zone = \'' . buzzcrud_config::$db_time_zone . '\'');
    }
