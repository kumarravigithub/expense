                                ...
                                <div class="col-sm-12">
                                    <section class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            $xcrud->pass_var('bank', 1);
                                            $xcrud->fields('dated,bank', true);
                                            $xcrud->columns('expense,price,head,income,bystaffid,refundableto,receivableto,bank');
                                            $xcrud->sum('price');
                                            $xcrud->limit(50);
                                            echo $xcrud->render();
                                            ?>
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#expensedate').change(function() {
                    window.location.replace("hdfc.php?d=" + $(this).val());
                });
            });
        </script>
    </body>
