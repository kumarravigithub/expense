...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Monthly Report | Expense</title>
                            ...
                            <div class="col-sm-12">
                                ...
                                <section class="panel">
                                    <div class="panel-body">
                                        <label class="col-sm-2 control-label">Select any day for that month</label>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-sm-12">
                                    <section class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            $xcrud->where("month(dated) = month('$d')");
                                            ...
                                            $xcrud->relation('bank', 'bank', 'id', 'name');
                                            $xcrud->label('refundableto','Given By');
                                            $xcrud->label('receivableto','Taken By');
                                            $xcrud->label('receivable','Taken?');
                                            $xcrud->pass_var('dated', $d);
                                            $xcrud->fields('dated', true);
                                            $xcrud->columns('dated,expense,price,head,income,refundableto,receivableto,bank');
                                            $xcrud->sum('price');
                                            $xcrud->limit(50);
                                            echo $xcrud->render();
                                            ?>
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#expensedate').change(function() {
                    window.location.replace("statement.php?d=" + $(this).val());
                });
            });
        </script>
    </body>
