<!DOCTYPE html>
<?php
// THIS IS REQUIRED FOR MENU ACTIVE STATUS
$office = 'class="active"';
$expense = 'style="display: none"';
$heads = 'style="display: none"';
$staff = 'style="display: none"';
$income = 'style="display: none"';
$uncategorised = 'style="display: none"';
...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Income Entry | Expense</title>
    ...
    <body>
                                ...
                                <div class="col-sm-12">
                                    <section class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            $xcrud->table('expense');
                                            $xcrud->where('dated =', $d);
                                            $xcrud->where('bystaffid =', 6);
                                            $xcrud->pass_var('dated', $d);
                                            $xcrud->pass_var('head', 0);
                                            $xcrud->pass_var('bystaffid', 6);
                                            $xcrud->fields('dated,bystaffid,head,income,refundable,refundableto,receivable,receivableto,timestamp', true);
                                            $xcrud->columns('expense,price');
        ...
        <script>
            document.title = localStorage.getItem("v");
            ...
            $(document).ready(function() {
                $('#expensedate').change(function() {
                    window.location.replace("office.php?d=" + $(this).val());
                });
            });
        </script>
    </body>
