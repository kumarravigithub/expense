...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Manage Heads | Expense</title>
            ...
            <aside class="bg-dark aside-sm" id="nav">
                <section class="vbox">
                    ...
                    <section>
                        ...
                        <?php $heads='class="active"'; require_once 'menu.php'; ?>
                    </section>
                                ...
                                <div class="blog-post">
                                    <div class="post-item">
                                        <div class="caption wrapper-lg">
                                            ...
                                            $xcrud->table('heads');
                                            $xcrud->subselect("This month expense","SELECT SUM(`price`) FROM `expense` WHERE MONTH(`dated`)=8 AND YEAR(`dated`)=YEAR(CURDATE()) AND `head`={id}");
                                            $xcrud->where("id>",0);
                                            $xcrud->limit(200);
                                            echo $xcrud->render();
                                            ?>
